...
public class BrowserFactory {
    ...
    private static final String MESSEGE_UNKNOWN_BROWSER = "Unknown browser type! Please check your configuration";
        ...
        if(isRemoteRun){
            ...
            switch(browserType){
                ...
                case IE:
                    ...
                    return getRemoteWebDriver(desiredCapabilities);
                default:
                    throw new IllegalStateException(MESSEGE_UNKNOWN_BROWSER);
            }
        }else{
            switch (browserType){
